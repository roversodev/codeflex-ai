            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div className="pt-2">
                  ...
                  <span className="text-primary"> IA Avançada</span>
                </div>
              </h1>
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Converse com nosso assistente de IA e obtenha planos de dieta e rotinas de exercícios
              ...
              <div className="flex items-center gap-10 py-6 font-mono">
                <div className="flex flex-col">
                  ...
                  <div className="text-xs uppercase tracking-wider">USUÁRIOS ATIVOS</div>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="text-xs uppercase tracking-wider">PERSONALIZADO</div>
                </div>
              </div>
